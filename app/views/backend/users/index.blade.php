        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading bg-blue">
                    ...
                    <a href="/dashboard/user/create" class="btn btn-warning col-md-offset-4">Crear Usuario</a>
                </div>
                            ...
                            <div class="row">
                                <div class="col col-md-12 buttons-page">
                                    ...
                                    @foreach (range('A', 'Z') as $letra)
                                        <button type="button" class="btn btn-sm btn-info filter-word btn-group" role="group" data-word="{{ $letra }}">{{ $letra }}</button>
                                    @endforeach
                                    <button type="button" class="btn btn-sm btn-danger filter-word btn-group" role="group" data-word="">Todas</button>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <hr>

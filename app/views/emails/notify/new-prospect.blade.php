...
<head>
  ...
  <title>Un nuevo prospecto se ha registrado.</title>
  <style type="text/css">
        ...
        <tr>
          ...
          <tr>
            <td style="padding: 1px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 27px; color: #333;">
            	<h3 style="font-weight: 600; font-size: 25px;">Un nuevo prospecto se ha registrado.</h3>
            	<p>
            		<strong>Nombre: </strong> {{ $name or $p->name }} <br>
            		<strong>Email: </strong> {{ $email or $p->email}} <br>
            		<strong>Teléfono: </strong> {{ $phone or $p->phone}} <br>
            	</p>  

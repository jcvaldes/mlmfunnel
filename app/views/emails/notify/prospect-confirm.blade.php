  ...
  <!-- This table wraps the whole body email within it's width (600px), sets the background color (white) and border (thin, gray, solid) -->
        ...
        <tr>
          ...
          <tr>
            <td style="padding: 1px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 27px; color: #333;">
                ...
                Hola y bienvenid@ {{ $prospect or '' }}!
              </h3>

              <hr>
                <p>
                    Hemos procesado con éxito tu suscripción y
                    este email es para confirmártelo.

                    En las próximas horas me pondré en contacto
                    contigo para brindarte todos los detalles de la
                    gran oportunidad que tengo para ti para ayudarte
                    a generar ingresos.
                    ...
                    PD.: te recuerdo nuevamente mis datos
                    de contacto:

                    Email:{{ $user->email or '' }}
                    Teléfono: {{ $user->phone or '' }}
                </p>
    ...
    <tr>
      <td style="text-align: center;padding: 40px 0px 0px 0px;font-family: sans-serif; font-size: 12px; line-height: 18px;color: #888888;">
        ...
        <a href="mailto:{{ Setting::key('app_mail')->first()->value }}" style="font-weight:bold; color: #8a929f;">{{ Setting::key('app_mail')->first()->value }}</a> &nbsp;<br><br>
      </td>
    </tr>
    <tr>
